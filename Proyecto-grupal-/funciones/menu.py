    ...
    while bandera:
        ...
        if eleccion == 1:
            ...
            while opcion3:
                ...
                if opcion == 1:
                    print(f"{funciones.ventas.encabezado[0]:<10} | {funciones.ventas.encabezado[1]:<10} | {funciones.ventas.encabezado[2]:<15} | {funciones.ventas.encabezado[3]:<16} | {funciones.ventas.encabezado[4]:<5}")
                    for fila in funciones.ventas.matriz_ventas:
                        IDnuevo, cantidadProductos, producto, importe, IDcliente = fila
                        print(f"{IDnuevo:<10} | {cantidadProductos:<10} | {producto:<15} | ${importe:<15} | {IDcliente:<5}")
                    ...
                    print(f"{funciones.ventas.encabezado[0]:<15} | {funciones.ventas.encabezado[1]:<20} | {funciones.ventas.encabezado[2]:>5} | {funciones.ventas.encabezado[3]:<15} | {funciones.ventas.encabezado[4]:>5}")
                    for fila in funciones.ventas.matriz_ventas:
                            IDnuevo, cantidadProductos, producto, importe, IDcliente = fila
                    ...
                    print(f"{funciones.ventas.encabezado[0]:<15} | {funciones.ventas.encabezado[1]:<20} | {funciones.ventas.encabezado[2]:>5} | {funciones.ventas.encabezado[3]:>5} | {funciones.ventas.encabezado[4]:>5}")
                    for fila in funciones.ventas.matriz_ventas:
                            IDnuevo, cantidadProductos, producto, importe, IDcliente = fila
                            print(f"{IDnuevo:<5} | {cantidadProductos:<10} | {producto:<15} | ${importe:<15} | {IDcliente:>10}")
